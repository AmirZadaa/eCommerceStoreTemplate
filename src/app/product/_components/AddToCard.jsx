  ...
  return (
       <div className='flex flex-col justify-center  space-y-4 border-2 h-fit py-4 px-2 max-md:px-20 max-xs:px-2'>
         ...
         <div className='flex w-full justify-center mx-auto  gap-2 mt-4 max-sm:flex-col hover:bg-background'>
           <CardSheet>
             <Button aria-label="add to card" className='hover:bg-background hover:text-foreground p-6 border-2 duration-300 border-primary font-bold text-md rounded-none w-full ' style="ghost"><ShoppingCart size={25}/>Add to cart</Button>
           </CardSheet>
